...
export default function PlayVolume() {
  const handleChange = (event: any) => {
    ...
    playAudio.volume = parseFloat(event.target.value) / 100; // thuộc tính volume để điều chỉnh âm thanh
    const volumeCurrent: any = document.querySelector(
      ".box-volume .inner-current"
    );
